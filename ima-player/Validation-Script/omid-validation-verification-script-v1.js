...
var module$contents$omid$validationVerificationScript$ValidationVerificationClient_DefaultLogServer = "http://localhost:66/sendmessage?msg=", module$exports$omid$validationVerificationScript$ValidationVerificationClient = function(a, b, c) {
  var d = this;
  c = void 0 === c ? module$contents$omid$validationVerificationScript$ValidationVerificationClient_DefaultLogServer : c;
  this.verificationClient_ = a;
  this.messageLogServer = c;
  a = this.verificationClient_.isSupported();
  this.logMessage_("OmidSupported[" + a + "]", (new Date()).getTime());
  a && (this.verificationClient_.registerSessionObserver(function(e) {
    return d.sessionObserverCallback_(e);
  }, b), Object.keys(module$exports$omid$common$constants.AdEventType).filter(function(e) {
    return module$exports$omid$common$constants.AdEventType[e] !== module$exports$omid$common$constants.AdEventType.MEDIA && module$exports$omid$common$constants.AdEventType[e] !== module$exports$omid$common$constants.AdEventType.VIDEO;
  }).forEach(function(e) {
    return d.verificationClient_.addEventListener(module$exports$omid$common$constants.AdEventType[e], function(f) {
      return d.omidEventListenerCallback_(f);
    });
  }));
};
...
module$exports$omid$validationVerificationScript$ValidationVerificationClient.prototype.sendUrl_ = function(a) {
  a = this.messageLogServer + encodeURIComponent(a);
  console.log(a);
